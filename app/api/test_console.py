...
def _session_snapshot(session) -> dict:
    return {
        ...
        "providers": {
            ...
            "primary_stt": session.primary_stt_provider or session.stt_provider,
            "primary_llm": session.primary_llm_provider or session.llm_provider,
            "primary_tts": session.primary_tts_provider or session.tts_provider,
        },
